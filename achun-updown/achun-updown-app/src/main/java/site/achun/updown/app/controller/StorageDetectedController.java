...
import site.achun.updown.app.service.module.detected.StorageDetectedService;
...
public class StorageDetectedController implements StorageDetectedClient {
    ...
    private final StorageDetectedService storageDetectedService;
    @Override
    public Rsp<Boolean> fileExist(QueryFileExist query) {
        String pathString = query.getStorageRootPath() + query.getInStoragePath();
        return Rsp.success(storageDetectedService.existFile(pathString));
    }
}
